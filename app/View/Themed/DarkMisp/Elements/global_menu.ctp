...
?>
<div id="topBar" class="fixed top-0 left-0 right-0 bg-mispnight border-b border-gray-800 px-6 py-4 flex items-center justify-between z-50 h-16 <?= isset($debugMode) ? $debugMode : 'debugOff' ?>" style="z-index:100;">
  <div class="navbar-innerflex items-center space-x-4">
    <ul class="nav">
        <?php
        if (isset($menu)) {
